...
**南京大学arduino教程（2021年的版本）**[repo](https://git.nju.edu.cn/nju_robot_club/carduino)             
...
- [openCV实战练习（3）——二维码、条形码扫描](https://blog.csdn.net/Crabfishhhhh/article/details/129082087)                 
...
- 墨问大讲堂|中国大学生计算机设计大赛-智慧物流挑战赛第一次培训[视频](https://www.bilibili.com/video/BV12T411n7vh/?p=1)          

- ROS外接usb摄像头标定方法[文章](https://blog.csdn.net/weixin_44543463/article/details/120704327)          

- 中国大学生计算机设计大赛[官网](http://jsjds.blcu.edu.cn/)      
...
- [CS入门技能树](https://edu.csdn.net/skill/gml?utm_source=AI_act_gml&category=635)                  

- [前端学习路线](https://objtube.github.io/front-end-roadmap/#/)              

- [软件工程入门指南](https://dunwu.github.io/blog/pages/c6742e/#%E8%BD%AF%E4%BB%B6%E5%B7%A5%E7%A8%8B%E5%85%A5%E9%97%A8%E6%8C%87%E5%8D%97)               
...
- 一个python人脸识别项目[Face recognition with OpenCV, Python, and deep learning](https://pyimagesearch.com/2018/06/18/face-recognition-with-opencv-python-and-deep-learning/)                      
- 一个网页制作项目[Django Girls 教程](https://tutorial.djangogirls.org/zh/)         
...
- 一个安卓计算器项目[How to Make a Calculator App for Android](https://www.thecrazyprogrammer.com/2014/08/calculator-app-for-android.html)               

- 一个很完整的知识库（全免费）[Java程序员进阶之路](https://tobebetterjavaer.com/)         

## -------------------------------------------------------
## Code教程            

- 国内最经典的大学生计算机自学网站[CS自学指南](https://csdiy.wiki/)         

- B站水论文的程序员个人博客，内容很丰富，博主本人也是AI方向[网址](https://www.cnblogs.com/nickchen121/)

- 搬书匠，收集各类编程语言各类计算机课程书籍[网址](http://www.banshujiang.cn/)           

- 南京大学计算机系统基础课程网站[网址](https://nju-projectn.github.io/ics-pa-gitbook/ics2022/)                

- oi wiki，致力于成为一个免费开放且持续更新的 **编程竞赛**中的基础知识、常见题型、解题思路以及常用工具等内容[网址](https://oi-wiki.org/)            

- 一位厦大数学系学长的知乎空间，除了大学数学的笔记还有AI数据挖掘等方向内容[链接](https://zhuanlan.zhihu.com/p/28617379)                  

- Quick Reference，为开发人员分享快速参考备忘清单【速查表】[链接](https://quickref.cn/index.html)                

- 南京大学名师蒋炎岩的个人网站，上面有很多资料与有趣的文章[链接](https://ics.nju.edu.cn/~jyy/)            

- 清华大学计算机系科协组织的酒井科协暑培，范围包括计算机基础，AI，前后端和游戏[链接](https://summer23.net9.org/)              
...
- 深度强化学习教程：Spinning Up中文版[链接](https://spinningup.readthedocs.io/zh_CN/latest/)[英文版](https://spinningup.openai.com/en/latest/)         

- 蘑菇书EasyRL（显然是对应西瓜书）[链接](https://datawhalechina.github.io/easy-rl/#/)          

- 南京大学人工智能学院强化学习课程主页（授课教师俞扬和章宗长都是LAMDA做RL水平极高的导师）[链接](https://www.lamda.nju.edu.cn/introrl/)           

- Stable-Baselines3 Docs - Reliable Reinforcement Learning Implementations[链接](https://stable-baselines3.readthedocs.io/en/master/)         
- 天授是一个基于PyTorch的深度强化学习平台[链接](https://tianshou.readthedocs.io/zh/master/)           

## ------------------------------------------------------- 

## 机器学习          

- 南瓜书，周志华西瓜书《机器学习》的公式推导书[链接](https://datawhalechina.github.io/pumpkin-book/#/)         

- 机器学习算法python实现[repo](https://github.com/Mryangkaitong/python-Machine-learning)            

- gitee上的ML算法python实现，可能对国内访问更友好[repo](https://gitee.com/fakerlove/machine-learning)            

- 《机器学习系统：设计和实现》，介绍机器学习底层基础设施的知识，研究生阶段可读价值很高[链接](https://openmlsys.github.io/index.html)             

- 南京大学20届AI本科生方同学的笔记整理，覆盖学科极广，深深被方同学的知识水平以及南大AI的教育深度广度折服[链接](https://notes.orangex4.cool/?git=github&github=fengdu78/Coursera-ML-AndrewNg-Notes)               

- Practical Machine Learning，CS 329P斯坦福机器学习课程，李沐是主讲人之一[链接](https://c.d2l.ai/stanford-cs329p/)             
- 人工智能系统（System for AI），微软的关于AI底层系统课程[链接](https://microsoft.github.io/AI-System/)            

- Roboflow，一个构建计算机视觉应用的平台[链接](https://docs.roboflow.com/)              

- The Full Stack，发布帮助人们构建AI赋能产品的视频课程[链接](https://www.youtube.com/@The_Full_Stack)             

- Stanford MLSys Seminars，斯坦福大学关于机器学习和系统前沿的研讨会[链接](https://www.youtube.com/@StanfordMLSysSeminars)      

- 浙大吴飞带领构建的人工智能开发平台[链接](https://momodel.cn/explore)               
...
- 动手学深度学习，大神李沐的著作[链接](https://zh-v2.d2l.ai/)            

- Hugging Face，国际上极为知名的深度学习平台[链接](https://huggingface.co/blog/zh)            

- labai机器学习平台[链接](https://labml.ai/)             

- labai中带注释的pytorch论文实现[链接](https://nn.labml.ai/zh/)                 

- 非常丰富的AIGC学习教程合集[Awesome AIGC Tutorials](https://github.com/luban-agi/Awesome-AIGC-Tutorials#awesome-aigc-tutorials)                

- 普林斯顿大学的LLM课程[链接](https://www.cs.princeton.edu/courses/archive/fall22/cos597G/)              
